...
<head>
    ...
    <link rel="icon" type="image/png" sizes="192x192" href="{{ asset('frontend/media/favicons/android-icon-192x192.png') }}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('frontend/media/favicons/apple-icon-180x180.png') }}">
    <!-- END Icons -->
