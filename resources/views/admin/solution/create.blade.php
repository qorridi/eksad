    ...
    @section('title')
        <title>BACKEND - Add New Solution</title>
    @endsection
            ...
            <div class="col-md-12 col-xl-12">
                <div class="block block-rounded h-100 mb-0">
                    <div class="block-content block-content-full">
                        <div class="row">
                            <div class="col-12">
                                {{ Form::open(['route'=>['admin.solution.store'],'method' => 'post','id' => 'form_create','class' => 'form-material space-y-3', 'enctype' => 'multipart/form-data', 'novalidate']) }}
{{--                                <form class="space-y-3" id="form_create_blog_category" method="POST" action="{{ route('admin.solution.store') }}">--}}
                                ...
                                <div class="row ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="name" name="name" class="form-control" placeholder="Nama Solution" value="{{old('name')}}" required/>
                                        </div>
                                    </div>
{{--                                    <div class="row">--}}
{{--                                        <div class="col-sm-3">--}}
