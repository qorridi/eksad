...
@section('title')
    <title>BACKEND - Add New Blog Category</title>
@endsection
            ...
            <div class="col-md-12 col-xl-12">
                <div class="block block-rounded h-100 mb-0">
                    <div class="block-content block-content-full">
                        <div class="row">
                            <div class="col-12">
                                <form class="space-y-3" id="form_create_blog_category" method="POST" action="{{ route('admin.blogcategory.store') }}">
                                    @csrf
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <input id="name" type="text" class="form-control"
                                                   name="name" value="{{ old('name') }}" placeholder="Blog Category Name" required>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
@section('scripts')
    ...
    <script>
        $('#form_create_blog_category').submit(function(){
            $('#btn_submit').hide();
            $('#btn_cancel').hide();
