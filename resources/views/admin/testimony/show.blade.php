...
@section('title')
    <title>BACKEND - Testimony Detail</title>
@endsection
                        ...
                        <div class="row">
                            <div class="col-12 space-y-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="name" name="name" class="form-control" placeholder="Client Name" value="{{$testimony->name}}" readonly/>
                                    </div>
                                </div>
                                <div class="row">
                                    <label class="col-sm-3 col-form-label" for="name">Company Name *</label>
                                    <div class="col-sm-9">
                                        <input type="text" id="company_name" name="company_name" class="form-control" placeholder="Company Name" value="{{ $testimony->company_name }}" readonly/>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="description" name="description" class="form-control" placeholder="Desc" value="{{$testimony->description}}" readonly/>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <img src="{{asset($testimony->image_path)}}" style="width: auto; height: 200px" class="pb-3">
                                    </div>
                                </div>
{{--                                <div class="row mb-3">--}}
{{--                                    <div class="col-12">--}}
...
{{--                                                        <textarea class="form-control" id="long_description" name="long_description" readonly>{!! $testimony->long_description !!}</textarea>--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
{{--                                                <!-- #END# Input -->--}}
{{--                                            </div>--}}
