                ...
                <div class="tab-pane active">
                    <div class="row mb-3">
                        <div class="col-12 text-end">
                            <a href="{{ route('admin.testimony.create') }}" class="btn btn-outline-success mt-lg-3"><i class="fas fa-plus"></i></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
...
@section('scripts')
    ...
    <script>
        $(function() {
            $('#table_blog').DataTable({
                ...
                responsive: false,
                ajax: {
                    url: '{!! route('admin.testimony.datatable') !!}'
                },
    ...
    @include('partials._deletejs', ['routeUrl' => 'admin.testimony.destroy', 'redirectUrl' => 'admin.testimony.index'])
@endsection
