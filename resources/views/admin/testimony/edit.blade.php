            ...
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
                ...
                <nav class="flex-shrink-0 mt-3 mt-sm-0 ms-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-alt">
                        ...
                        <li class="breadcrumb-item">
                            <a class="link-fx" href="{{ route('admin.testimony.index') }}">Testimony List</a>
                        </li>
            ...
            <div class="col-md-12 col-xl-12">
                <div class="block block-rounded h-100 mb-0">
                    <div class="block-content block-content-full">
                        <div class="row">
                            <div class="col-12">
                                {{ Form::open(['route'=>['admin.testimony.update'],'method' => 'post','id' => 'form_update','class' => 'form-material space-y-3', 'enctype' => 'multipart/form-data', 'novalidate']) }}
                                ...
                                <div class="row">
                                    <div class="col-12 text-end">
                                        ...
                                        <a id="btn_cancel" href="{{ route('admin.testimony.index') }}" class="btn btn-outline-danger">Cancel</a>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="text" id="name" name="name" class="form-control" placeholder="Client Name" value="{{ $testimony->name }}" required/>
                                    </div>
                                </div>
                                <div class="row">
                                    <label class="col-sm-3 col-form-label" for="name">Company Name *</label>
                                    <div class="col-sm-9">
                                        <input type="text" id="company_name" name="company_name" class="form-control" placeholder="Company Name" value="{{ $testimony->company_name }}" required/>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="description" name="description" class="form-control" placeholder="Desc" value="{{ $testimony->description }}"/>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-8">
                                        <img id="old_picture" src="{{ asset($testimony->image_path) }}" width="200"/>
                                    </div>
                                </div>
...
{{--                                                        <textarea class="form-control" id="long_description" name="long_description">{!! $testimony->long_description !!}</textarea>--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
{{--                                                <!-- #END# Input -->--}}
{{--                                            </div>--}}
