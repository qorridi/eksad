            ...
            <div class="col-md-12 col-xl-12">
                <div class="block block-rounded h-100 mb-0">
                    <div class="block-content block-content-full">
                        <div class="row">
                            <div class="col-12">
                                <form class="space-y-3" id="form_edit_job_vacancy_level" method="POST" action="{{ route('admin.vacancylevel.update', $category->id) }}">
                                    @csrf
                                    <div class="row">
...
@section('scripts')
    ...
    <script>
        $('#form_edit_job_vacancy_level').submit(function(){
            $('#btn_submit').hide();
            $('#btn_cancel').hide();
