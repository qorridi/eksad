...
@section('title')
    <title>BACKEND - Admin User</title>
@endsection
                ...
                <div class="tab-pane active">
                    <div class="row mb-3">
                        <div class="col-12 text-end">
                            <a href="{{ route('admin.adminuser.create') }}" class="btn btn-outline-success mt-lg-3" ><i class="fas fa-plus"></i></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="table-responsive w-100" >
                                <table class="table table-bordered table-striped table-vcenter js-dataTable-full" id="table_admin_user">
                                    <thead>
                                    <tr>
...
@section('scripts')
    ...
    <script>
        $(function() {
            $('#table_admin_user').DataTable({
                ...
                responsive: false,
                ajax: {
                    url: '{!! route('admin.adminuser.datatable') !!}'
                },
    ...
    @include('partials._deletejs', ['routeUrl' => 'admin.adminuser.destroy', 'redirectUrl' => 'admin.adminuser.index'])
@endsection
