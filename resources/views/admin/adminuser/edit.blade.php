...
@section('title')
    <title>BACKEND - Edit Admin User</title>
@endsection
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
                ...
                <nav class="flex-shrink-0 mt-3 mt-sm-0 ms-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-alt">
                        ...
                        <li class="breadcrumb-item">
                            <a class="link-fx" href="{{ route('admin.adminuser.index') }}">Edit Admin User</a>
                        </li>
            ...
            <div class="col-md-12 col-xl-12">
                <div class="block block-rounded h-100 mb-0">
                    <div class="block-content block-content-full">
                        <div class="row">
                            <div class="col-12">
                                <form class="space-y-3" id="form_edit_admin_user" method="POST" action="{{ route('admin.adminuser.update', $adminUser->id) }}">
                                    @csrf
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <input id="name" type="text" class="form-control"
                                                   name="name" value="{{ $adminUser->name }}" placeholder="Name" >
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <input id="email" type="text" class="form-control"
                                                   name="email" value="{{ $adminUser->email }}" placeholder="Email" >
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <input id="phone" type="text" class="form-control"
                                                   name="phone" value="{{ $adminUser->phone }}" placeholder="Phone" >
                                        </div>
                                    </div>
                                </form>
                            </div>
...
@section('scripts')
    ...
    <script>
        $('#form_edit_admin_user').submit(function(){
            $('#btn_submit').hide();
            $('#btn_cancel').hide();
