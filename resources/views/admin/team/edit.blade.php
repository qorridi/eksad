            ...
            <div class="col-md-12 col-xl-12">
                <div class="block block-rounded h-100 mb-0">
                    <div class="block-content block-content-full">
                        <div class="row">
                            <div class="col-12">
                                {{ Form::open(['route'=>['admin.team.update', $team->id],'method' => 'post','id' => 'form_edit_blog','class' => 'form-material space-y-3', 'enctype' => 'multipart/form-data', 'novalidate']) }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" id="name" name="name" class="form-control"
                                               placeholder="Nama" value="{{$team->name}}" required/>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" id="position" name="position" class="form-control"
                                               placeholder="position" value="{{$team->position}}" required/>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea id="description" name="description" class="form-control" rows="4" maxlength="150"> {{ $team->description }}</textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" id="sosmed_1" name="sosmed_1" class="form-control"
                                               placeholder="Link Twitter" value="{{$team->sosmed_1}}"/>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" id="sosmed_2" name="sosmed_2" class="form-control"
                                               placeholder="Link Linkedin" value="{{$team->sosmed_2}}"/>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" id="sosmed_3" name="sosmed_3" class="form-control"
                                               placeholder="Link Instagram" value="{{$team->sosmed_3}}"/>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-sm-3">
                                        ...
                                        <br>
                                        <img src="{{ asset($team->img_path) }}" style="width:100%" alt="team-image">
                                    </div>
                                    <div class="col-sm-6">
