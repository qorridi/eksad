                ...
                <div class="tab-pane active">
                    <div class="row mb-3">
                        <div class="col-12 text-end">
                            <a href="{{ route('admin.team.create') }}" class="btn btn-outline-success mt-lg-3" ><i class="fas fa-plus"></i></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="table-responsive w-100" >
                                <table class="table table-bordered table-striped table-vcenter js-dataTable-full" id="table_information">
                                    <thead>
                                    <tr>
...
@section('scripts')
        ...
        $(function() {
            $('#table_information').DataTable({
                ...
                columns: [
                    ...
                    { data: 'status', name: 'status', class: 'text-center', searchable: 'false'},
    ...
    @include('partials._deletejs', ['routeUrl' => 'admin.team.destroy', 'redirectUrl' => 'admin.team.index'])
@endsection
