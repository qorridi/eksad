...
{{--    </div>--}}
    ...
    <div class="content">
        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                <h3 class="block-title">Floating Labels Edited</h3>
            </div>
                ...
                <form action="be_forms_elements.html" method="POST" onsubmit="return false;">
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-xl-10 text-center">
                            ...
                            <div class="form-floating mb-4">
                                <textarea class="form-control" id="address" name="address" style="height: 200px" placeholder="Address"></textarea>
                                <label for="address">Address</label>
                            </div>
                            <div class="row mb-4">
                                <div class="form-floating col-6">
                                    <input type="text" class="form-control" placeholder="">
                                    <label for="example-text-input-floating" style="left: 15px;">Col-6 left</label>
                                </div>
                                <div class="form-floating col-6">
                                    <input type="text" class="form-control" placeholder="col-6 right">
                                    <label for="example-text-input-floating" style="left: 15px;">Col-6 right</label>
                                </div>
                            </div>
                            <div class="form-floating mb-4">
                                <input type="password" class="form-control" id="example-password-input-floating" name="example-password-input-floating" placeholder="Password">
