...
@section('title')
    <title>BACKEND - Add New Blog</title>
@endsection
            ...
            <div class="col-md-12 col-xl-12">
                <div class="block block-rounded h-100 mb-0">
                    <div class="block-content block-content-full">
                        <div class="row">
                            <div class="col-12">
                                {{ Form::open(['route'=>['admin.blog.store'],'method' => 'post','id' => 'form_create_blog','class' => 'form-material space-y-3', 'enctype' => 'multipart/form-data', 'novalidate']) }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <select id="status_id" name="status_id" class="custom-select form-control">
                                            ...
                                            <option value="9" >UNPUBLISH</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" id="title" name="title" class="form-control" placeholder="Judul Blog" value="{{old('title')}}" required/>
                                    </div>
                                </div>
                                <div class="row ">
                                    <div class="col-sm-3">
                                        ...
                                        <select id="category" name="category" class="custom-select form-control">
                                            ...
                                            @foreach($categories as $category)
                                                @if(!empty(old('category')))
                                                    <option value="{{ $category->id }}" @if($category->id == old('category')) selected @endif >{{ $category->description }}</option>
                                                @else
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" id="subtitle" name="subtitle" class="form-control" placeholder="Short Description" value="{{old('subtitle')}}"/>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-3">
...
@section('styles')
    ...
    <!--<link href="{{ asset('custom/summernote-0.8.18-dist/summernote.min.css') }}" rel="stylesheet">-->
...
@section('scripts')
    ...
    <!--<script src="{{ asset('custom/summernote-0.8.18-dist/summernote.min.js') }}"></script>-->
