                ...
                <div class="tab-pane active">
                    <div class="row mb-3">
                        <div class="col-12 text-end">
                            <a href="{{ route('admin.blog.create') }}" class="btn btn-outline-success mt-lg-3" ><i class="fas fa-plus"></i></a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="table-responsive w-100" >
                                <table class="table table-bordered table-striped table-vcenter js-dataTable-full" id="table_blog">
                                    <thead>
                                    <tr>
                                        <th style='width:10%'>Tanggal published</th>
                                        <th style='width:10%'>Tanggal modified</th>
    ...
    <script>
        $(function() {
            $('#table_blog').DataTable({
                ...
                order: [ [1, 'asc'] ],
                columns: [
                    { data: 'published_at', name: 'published_at', class: 'text-center', orderable: true, searchable: false,
                    ...
                    { data: 'category', name: 'category_name', class: 'text-center', searchable: 'false'},
                    { data: 'status', name: 'status_description', class: 'text-center', searchable: 'false'},
