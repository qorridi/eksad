...
@section('title')
    <title>BACKEND - Subscriber List</title>
@endsection
    ...
    <script>
        $(function() {
            $('#table_complaint').DataTable({
                ...
                responsive: false,
                ajax: {
                    url: '{!! route('admin.subscribe.datatable') !!}'
                },
        ...
        @include('partials._deletejs', ['routeUrl' => 'admin.subscribe.destroy', 'redirectUrl' => 'admin.subscribe.index'])
@endsection
